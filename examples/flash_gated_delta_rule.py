...
def flash_chunk_gated_delta_rule_fwd(
    ...
    g = ascendc_chunk_local_cumsum(
        ...
        chunk_size=chunk_size,
        cu_seqlens=cu_seqlens,
        chunk_indices_out=_chunk_tensor(chunk_indices, chunk_size),
        head_first=True,
    )
    ...
    if cu_list is None:
        A = ascendc_solve_tri(A.to(k.dtype), layout="bhtd")
    else:
        A_token_first = A.transpose(1, 2).contiguous().squeeze(0)
        A_token_first = ascendc_solve_tri(
