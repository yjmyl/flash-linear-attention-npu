...
namespace l0op {
OP_TYPE_REGISTER(ChunkCumsumKkt);
...
const std::array<const aclTensor *, 2> ChunkCumsumKkt(
    const aclTensor *k,
    const aclTensor *g,
...
{
    L0_DFX(ChunkCumsumKkt, k, g, beta, cuSeqlensOptional, chunkIndicesOptional, chunkSize,
           gCumsumOut, aOut);
